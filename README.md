...
- **Dramatic stars** — boiling, textured star surfaces under a blinding halo glow, pulsing coronas, and a realistic camera lens flare (anamorphic streak plus a chain of chromatic hexagonal aperture ghosts) when a sun is in view; in binary systems, a weaving two-layer fire ring threads through both suns and follows the smaller one around its orbit, trailed by wobbling embers. A softly twinkling starfield sits behind wispy, filamentary nebulae and faint cosmic dust veils.
